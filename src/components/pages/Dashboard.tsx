...
import { ShoppingCart, Heart, Trash2, ArrowRight, X } from 'lucide-react';
    ...
    <div className={`min-h-[80vh] flex flex-col items-center justify-start ${isDark ? 'bg-black text-white' : 'bg-white text-black'}`}> 
      <div className="w-full max-w-2xl">
        ...
        <div className="flex justify-center gap-8 mb-4 border-b border-gray-200 dark:border-gray-800">
          <button
            className={`pb-3 px-2 text-lg font-medium transition-colors duration-200 border-b-2 ${
              activeTab === 'cart'
                ? isDark
        ...
        {activeTab === 'cart' && (
          <div className="flex flex-col items-center justify-center min-h-[320px]">
            {cartProducts.length === 0 ? (
              <div className="flex flex-col items-center justify-center w-full max-w-md mx-auto py-16 px-6 bg-white dark:bg-gray-900 rounded-2xl shadow-md border border-gray-100 dark:border-gray-800">
              ...
              <>
                <div className="space-y-6 mb-8 w-full">
                  {cartProducts.map((product: any) => (
                    <div key={product.id} className="flex items-center gap-5 rounded-xl p-5 shadow-sm border border-gray-100 dark:border-gray-800">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-3 mt-2">
                          ...
                          <input
                            ...
                            className="w-14 border rounded px-2 py-1 text-center text-base bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-700 text-black dark:text-white"
                          />
                          <button
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between border-t pt-6 mt-6 gap-4 w-full">
                  ...
                  <button
                    ...
                    className="mt-2 md:mt-0 px-8 py-3 rounded-full font-bold text-base transition-all duration-200 bg-black text-white dark:bg-white dark:text-black hover:bg-gray-900 dark:hover:bg-gray-200"
                  >
        ...
        {activeTab === 'liked' && (
          <div className="flex flex-col items-center justify-center min-h-[0] w-full">
            {likedProducts.length === 0 ? (
              <div className="flex flex-col items-center justify-center w-full max-w-md mx-auto py-16 px-6 bg-white dark:bg-gray-900 rounded-2xl shadow-md border border-gray-100 dark:border-gray-800 mt-0">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-3 mt-2">
                        ...
                        <button
                          ...
                          className="px-6 py-2 rounded-full font-semibold text-base transition-all duration-200 bg-black text-white dark:bg-white dark:text-black hover:bg-gray-900 dark:hover:bg-gray-200"
                        >
                          Add to Cart
                        </button>
                        <button
        ...
        {showCheckout && user && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
            <div className={`rounded-2xl border p-10 max-w-md w-full relative ${isDark ? 'bg-black border-gray-800' : 'bg-white border-gray-200'}`}> 
              <button
              ...
              <form onSubmit={e => { e.preventDefault(); handleConfirmPayment(); }}>
                <div className="mb-4">
                  ...
                  <input
                    ...
                    className="w-full border rounded px-3 py-3 text-base bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-700 text-black dark:text-white"
                ...
                <div className="mb-8">
                  ...
                  <select
                    ...
                    onChange={handleInputChange}
                    className="w-full border rounded px-3 py-3 mb-3 text-base bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-700 text-black dark:text-white"
                    required
                  > 
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className="w-full border rounded px-3 py-3 text-base bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-700 text-black dark:text-white"
                    placeholder="Enter UPI ID or Card Details"
                  />
                </div>
                <button
                  type="submit"
                  className="w-full px-8 py-4 rounded-full font-bold text-base transition-all duration-200 bg-black text-white dark:bg-white dark:text-black hover:bg-gray-900 dark:hover:bg-gray-200"
                >
                  Pay Now
                </button>
              </form>
